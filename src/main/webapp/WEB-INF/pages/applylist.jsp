            ...
            <table id=grid
                ...
                <c:forEach items="${applylist}" var="apply">
                    <tr style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
                        ...
                        <td>
                            <a class="link-update"
                               href="${pageContext.request.contextPath}/zulist/toaddhetong?house_id=${apply.house_id}">同意租赁</a>
                            <input type="hidden" name="id" value="${houselist.id}"/>
                            <a class="link-del"
                               href="${pageContext.request.contextPath}/refuseapply?house_id=${apply.house_id}"
