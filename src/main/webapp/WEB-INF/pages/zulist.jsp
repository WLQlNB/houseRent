...
<div>
    ...
    <form id="houseForm" name="houseForm"
          action="${pageContext.request.contextPath}/zulist/findzulist" method=post>
        <div class="result-title">
                ...
                <c:forEach items="${zulist}" var="zulist">
                    <tr style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
                        ...
                        <td><a class="link-update"
                               href="${pageContext.request.contextPath}/hetong/seehetong?house_id=${zulist.house_id }">查看合同</a>
                            <a class="link-del"
                               href="${pageContext.request.contextPath}/hetong/deletehetong?house_id=${zulist.house_id }"
