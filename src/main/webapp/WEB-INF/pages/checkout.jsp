...
<div>
    <form id="houseForm" name="houseForm" action="${pageContext.request.contextPath}/checkout/getallcheckout"
          method=post>
        <div class="result-title">
                ...
                <c:forEach items="${checkout}" var="checkout">
                    <tr style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
                        ...
                        <td>
                            ...
                            <a class="link-del"
                               href="${pageContext.request.contextPath}/checkout/admindeletecheckout?id=${checkout.id}"
