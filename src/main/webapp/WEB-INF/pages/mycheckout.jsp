...
<div>
    ...
    <form id="houseForm" name="houseForm" action="${pageContext.request.contextPath}/checkout/getmycheckout" method=post>
        <div class="result-title">
            ...
            <table id=grid
                ...
                <c:forEach items="${userlistcheck}" varStatus="i" var="userlist">
                    ...
                    <c:forEach items="${userlist.checkout}" var="checkout">
                        ...
                        <td>
                            <a class="link-del"
                               href="${pageContext.request.contextPath}/checkout/deletecheckout?id=${checkout.id }"
