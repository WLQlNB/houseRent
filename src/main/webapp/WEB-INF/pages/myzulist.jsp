                ...
                <c:forEach items="${userlistzu}" varStatus="i" var="userlist">
                    ...
                    <c:forEach items="${userlist.zulist}" var="zulist">
                        ...
                        <td><a class="link-update"
                               href="${pageContext.request.contextPath}/hetong/zukeseehetong?house_id=${zulist.house_id }">查看合同</a>
                            &nbsp;&nbsp; <a class="link-del"
                                            href="${pageContext.request.contextPath}/applyout/insertapplyout?house_id=${zulist.house_id }"
